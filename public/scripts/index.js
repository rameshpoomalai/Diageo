...
function loadItems() {
    ...
    xhrGet(REST_DATA+"?topic="+topic, function(data) {
        ...
        //console.log(receivedItems);
          ...
          // for(pcount=0;pcount<receivedItems.passages.length;pcount++)
          // {
          //     var lineItem = {"docname":receivedItems.passages[pcount].document_id, "doctype":"unknown","highlight":receivedItems.passages[pcount].passage_text,
          //     "altColumn":altColumn,"passage":true};
          //     passages.push(lineItem);
          // }
          //
          // for (i = 0; i < passages.length; ++i) {
          //
          //    addItem(passages[i], !hasItems);
          // }
          //
          //
          // var newRow = document.createElement('tr');
          // newRow.innerHTML="<td width=20%><div class='contentHeader'><h3>Document Results:</h3></div></td><td width=80%><div class='contentHeader'>&nbsp;</div></td>";
          // newRow.className = "tableRows";
          // document.getElementById('notes').lastChild.appendChild(newRow);
        ...
        for (i = 0; i < receivedItems.results.length; ++i) {
            var item = receivedItems.results[i].highlight.text1  ;
            ...
            for (j = 0; j < item.length; ++j) {
              ...
              var lineItem = {"docname":docname, "doctype":doctype,"highlight":item[j],"altColumn":altColumn,"passage":false};
              items.push(lineItem);

...
app.get('/api/search', function(request, response) {
    ...
    // let baseQuery = '/query?version=2018-08-01&deduplicate=true&deduplicate.field=text&highlight=true&count=5&return=highlight,extracted_metadata,passages&passages=true&&passages.count=3&passages.fields=text&natural_language_query=';
